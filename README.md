...
- [Write a program which accepts a number from the user and prints the frequency of the number in the list LST, if number is not in the LST it should print “Number not available"](https://github.com/MdMobid/Basic-Python-Programs/blob/main/School%20Problems/Code5.py)
